...
const DeleteModalLayout: React.FC<ModalLayoutProps> = ({
    ...
    return (
        ...
        >
            <div className="w-[98%] sm:w-[90%] md:w-[70%] max-h-[90%] lg:w-[60%] bg-white dark:bg-meta-4 rounded-xl overflow-y-auto">
                <ClickOutside onClick={onClose}>
                    <div className="w-full mx-auto py-2 flex justify-end items-center bg-red-500 pl-4">
                        <div className="w-full flex justify-between items-center">
                            <h5 className="poppin-600 text-xl capitalize text-white">
                                {headerText}
                            </h5>
