...
const ButtonAdd = ({
    ...
    return (
      ...
      flex items-center justify-center rounded-md border px-4 py-[5px] transition-all ease-in-out duration-300 hover:text-primary hover:bg-inherit hover:dark:text-primary-thin hover:dark:bg-boxdark2"
        >
